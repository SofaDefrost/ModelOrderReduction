...
template <class DataTypes>
const typename HyperReducedHexahedronFEMForceField<DataTypes>::Transformation& HyperReducedHexahedronFEMForceField<DataTypes>::getElementRotation(const unsigned elemidx)
{
...
template<class DataTypes>
void HyperReducedHexahedronFEMForceField<DataTypes>::computeElementStiffness( ElementStiffness &K, const MaterialStiffness &M, const helper::fixed_array<Coord,8> &nodes, const int elementIndice, double stiffnessFactor)
{
// 	serr<<"HyperReducedHexahedronFEMForceField<DataTypes>::computeElementStiffnessAsFinest"<<sendl;
...
template<class DataTypes>
typename HyperReducedHexahedronFEMForceField<DataTypes>::Mat33 HyperReducedHexahedronFEMForceField<DataTypes>::integrateStiffness( int signx0, int signy0, int signz0, int signx1, int signy1, int signz1, const Real u, const Real v, const Real w, const Mat33& J_1  )
{
...
template<class DataTypes>
void HyperReducedHexahedronFEMForceField<DataTypes>::computeMaterialStiffness(int i)
{
...
template<class DataTypes>
void HyperReducedHexahedronFEMForceField<DataTypes>::computeForce( Displacement &F, const Displacement &Depl, const ElementStiffness &K )
{
...
template<class DataTypes>
void HyperReducedHexahedronFEMForceField<DataTypes>::initSmall(int i, const Element &elem)
{
...
template<class DataTypes>
void HyperReducedHexahedronFEMForceField<DataTypes>::computeRotationLarge( Transformation &r, Coord &edgex, Coord &edgey)
{
...
template<class DataTypes>
void HyperReducedHexahedronFEMForceField<DataTypes>::initPolar(int i, const Element& elem)
{
    defaulttype::Vec<8,Coord> nodes;
    for(int j=0; j<8; ++j)
...
template<class DataTypes>
void HyperReducedHexahedronFEMForceField<DataTypes>::computeRotationPolar( Transformation &r, defaulttype::Vec<8,Coord> &nodes)
{
    Transformation A;
...
template<class DataTypes>
inline SReal HyperReducedHexahedronFEMForceField<DataTypes>::getPotentialEnergy(const core::MechanicalParams*) const
{
...
template<class DataTypes>
void HyperReducedHexahedronFEMForceField<DataTypes>::computeBBox(const core::ExecParams* params, bool onlyVisible)
{
...
// 	serr<<"HyperReducedHexahedronFEMForceField<DataTypes>::draw()"<<sendl;
