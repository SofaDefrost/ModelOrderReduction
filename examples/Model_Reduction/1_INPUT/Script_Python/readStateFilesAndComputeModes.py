...
stateFilename =             morConfigFile['stateFile']['pathTodir']+morConfigFile['stateFile']['nameStateFile']+".state"
initPositionFilename =      morConfigFile['stateFile']['pathTodir']+morConfigFile['stateFile']['nameStateFile']+"_init.state"
modesFilePath =             morConfigFile['modes']['pathTodir']
modesFileName =             morConfigFile['modes']['modesFileName']
tol =                       morConfigFile['modes']['tolerance']
addRigidBodyModes =         morConfigFile['modes']['addRigidBodyModes']
