...
#                rootNode.findData('dt').value=1
		...
		poissonRatio = 0.45
                ...
                feuille.createObject('TetrahedronHyperelasticityFEMForceField',name='DiamondWellConverged_HyperElasticHyperReducedFF_Quite_'+ str(nbModes), materialName="MooneyRivlin", ParameterSet=str(c_1) + " " + str(c_2) + " " + str(k0_), AnisotropyDirections="", printLog="1")    
