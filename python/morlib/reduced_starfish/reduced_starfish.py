...
def Reduced_starfish(
    ...
    model_MOR.createObject('MechanicalMatrixMapperMOR' , nodeToParse='@./model', object1 = '@./MechanicalObject', object2 = '@./MechanicalObject', listActiveNodesPath = path + '/data/conectivity_model.txt', template = 'Vec1d,Vec1d', performECSW = 'True')
