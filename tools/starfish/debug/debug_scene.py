...
paramWrapper = [('/model', {'paramForcefield': {'periodSaveGIE': 3, 'prepareECSW': True, 'modesPath': '/home/felix/SOFA/plugin/ModelOrderReduction/tools/tests/data/test_modes.txt', 'nbTrainingSet': 320}, 'paramMORMapping': {'input': '@../MechanicalObject', 'modesPath': '/home/felix/SOFA/plugin/ModelOrderReduction/tools/tests/data/test_modes.txt'}, 'subTopo': 'modelSubTopo', 'paramMappedMatrixMapping': {'object1': '@./MechanicalObject', 'object2': '@./MechanicalObject', 'performECSW': False, 'template': 'Vec1d,Vec1d'}}), ('/model/modelSubTopo', {'paramForcefield': {'periodSaveGIE': 3, 'prepareECSW': True, 'modesPath': '/home/felix/SOFA/plugin/ModelOrderReduction/tools/tests/data/test_modes.txt', 'nbTrainingSet': 320}})]
